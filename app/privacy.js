    ...
    <View>
      ...
      <ScrollView contentContainerStyle={styles.mainContainer}>
        <View style={styles.boxContainer}>
          ...
          <Text style={styles.iconLink} onPress={() => flagsLink()}>Więcej informacji</Text>
        </View>
        ...
        <View style={styles.boxContainer}>
          ...
          <Text style={styles.iconLink} onPress={() => backArrowLink()}>Więcej informacji</Text>
        </View>
        ...
        <View style={styles.boxContainer}>
          ...
          <Text style={styles.iconLink} onPress={() => categoriesAndCardsLink()}>Więcej informacji</Text>
        </View>
        ...
        <View style={styles.boxContainer}>
          ...
          <Text style={styles.iconLink} onPress={() => addPlayersLink()}>Więcej informacji</Text>
        </View>
        ...
        <View style={styles.boxContainer}>
          ...
          <Text style={styles.iconLink} onPress={() => socialMediaLink()}>Więcej informacji</Text>
        </View>
